...
public class AdminProductCtrl extends Controller {
    ...
    public Result listProducts(Long cat) {
        ...
        return ok(views.html.productAdmin.listProducts.render(env, categories, products, getCurrentUser()));
    }
    ...
    public Result addProduct() {   
        ...
        return ok(views.html.productAdmin.addProduct.render(addProductForm, getCurrentUser()));
    }
    ...
    public Result addProductSubmit() {
        ...
        if(newProductForm.hasErrors()) {
            ...
            return badRequest(views.html.productAdmin.addProduct.render(newProductForm, getCurrentUser()));
        }
